## Disclaimer: this logic is built based on the Security Diagram found
## here: https://confluence.energy.svc.dbgcloud.io/display/IO/Security+onboarding+process+description+-+Energy+IT
## If the Security Diagram changes, the logic below MUST be adapted accordingly
